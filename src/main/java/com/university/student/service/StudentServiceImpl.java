...
public class StudentServiceImpl implements StudentService {
	...
	private StudentVO convertToVO(Student student) {
		if(student == null)
			return null;
		return new StudentVO(student.getStudentId(), student.getStudentName(), student.getEnrollmentYear(), convertToVO(student.getDepartment()));
	}
	
	private Student convertToDTO(StudentVO student) {
		if(student == null)
			return null;
		return new Student(student.getStudentId(), student.getStudentName(), student.getEnrollmentYear(), convertToDTO(student.getDepartment()));
	}
