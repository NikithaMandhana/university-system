...
public class FacultyServiceImpl implements FacultyService {
	...
	private FacultyVO convertToVO(Faculty faculty) {
		if(faculty == null)
			return null;
		return new FacultyVO(faculty.getFacultyId(), faculty.getFacultyName(), faculty.getDesignation(), convertToVO(faculty.getDepartment()));
	}
	
	private Faculty convertToDTO(FacultyVO faculty) {
		if(faculty == null)
			return null;
		return new Faculty(faculty.getFacultyId(), faculty.getFacultyName(), faculty.getDesignation(), convertToDTO(faculty.getDepartment()));
	}
